...
* **Dynamic Environment Logic:** Supports seamless switching between prod, stg, and other environments via the LOCUST_ENV variable and a centralized configuration loader.
...
<pre>
Bash
LOCUST_ENV=prod locust -f locustfile.py --headless -u 10 -r 1 --run-time 1m --html locust_report.html
</pre>
